...
Un pays avec une population côtière plus importante produit légèrement plus de déchets plastiques par habitant. Comme la population côtière est généralement plus faible que la non côtière, la majorité des points se concentrent au début du graphique (x < 1). Mais la tendance reste faible, l'augmentation des déchets est légère. Les vraies différences viennent surtout des continents(richesse) et de la gestion des déchets.